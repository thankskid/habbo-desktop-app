const { BrowserWindow: e, globalShortcut: i } = require('electron'),
  s = require('path'),
  t = require('url');
const client = require('discord-rich-presence')('788846640051388498');
const axios = require('axios');

let userCounter = `http://dev9283.habbo.is/patcher/core/onlinecounter.php`;
...
class n {
  constructor(n = 1200, r = 800, o = !0, l = !0, w = !1, c) {
    (this._window = new e({
      ...
      client.updatePresence({
        details: 'Spielt gerade Habbo.is',
        //   state: `${username}`,
      ...
      (this._fullScreen = w),
      'home' === this._view &&
        (i.register('Command+Shift+F', () => {
          this._window.isFocused() && this._window.setFullScreen(!0);
        }),
        i.register('Command+Shift+I', () => {
  ...
  toggleFullScreen() {
    (this._fullScreen = !this.getFullScreen()),
      this._window.setFullScreen(this._fullScreen);
  }
  getFullScreen() {
